...
// Overloaded func when dist not provided
int getSpeed(double time) {
    return static_cast<int>(100 / time); // Assuming a defautl distance of 100 units
}

// Overload func to get speed in specific format
